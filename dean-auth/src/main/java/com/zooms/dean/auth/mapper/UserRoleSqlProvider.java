...
import com.zooms.dean.auth.domain.UserRoleExample.Criteria;
import com.zooms.dean.auth.domain.UserRoleExample.Criterion;
...
public class UserRoleSqlProvider {
    ...
    public String countByExample(UserRoleExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("auth_user_role");
    ...
    public String deleteByExample(UserRoleExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("auth_user_role");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(UserRoleKey record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("auth_user_role");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserRoleKey record = (UserRoleKey) parameter.get("record");
        UserRoleExample example = (UserRoleExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("auth_user_role");
