...
import com.zooms.dean.auth.domain.AuthorityExample.Criteria;
import com.zooms.dean.auth.domain.AuthorityExample.Criterion;
...
public class AuthoritySqlProvider {
    ...
    public String countByExample(AuthorityExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("auth_authority");
    ...
    public String deleteByExample(AuthorityExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("auth_authority");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(Authority record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("auth_authority");
        ...
        if (record.getDomainForce() != null) {
            sql.VALUES("domain_force", "#{domainForce,jdbcType=VARCHAR}");
        }
        
        if (record.getGlobal() != null) {
            sql.VALUES("global", "#{global,jdbcType=BIT}");
        }
    ...
    public String selectByExample(AuthorityExample example) {
        ...
        sql.SELECT("domain_force");
        sql.SELECT("global");
        sql.SELECT("create_date");
        sql.SELECT("update_date");
        sql.SELECT("remarks");
        sql.SELECT("del_flag");
        sql.FROM("auth_authority");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getDomainForce() != null) {
            sql.SET("domain_force = #{record.domainForce,jdbcType=VARCHAR}");
        }
        
        if (record.getGlobal() != null) {
            sql.SET("global = #{record.global,jdbcType=BIT}");
        }
    ...
    public String updateByPrimaryKeySelective(Authority record) {
        ...
        if (record.getDomainForce() != null) {
            sql.SET("domain_force = #{domainForce,jdbcType=VARCHAR}");
        }
        
        if (record.getGlobal() != null) {
            sql.SET("global = #{global,jdbcType=BIT}");
        }
