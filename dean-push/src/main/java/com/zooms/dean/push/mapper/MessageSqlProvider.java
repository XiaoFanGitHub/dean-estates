...
import com.zooms.dean.push.domain.MessageExample.Criteria;
import com.zooms.dean.push.domain.MessageExample.Criterion;
...
public class MessageSqlProvider {
    ...
    public String insertSelective(Message record) {
        ...
        if (record.getGoType() != null) {
            sql.VALUES("go_type", "#{goType,jdbcType=INTEGER}");
        }
        
        if (record.getGoValue() != null) {
            sql.VALUES("go_value", "#{goValue,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getGoType() != null) {
            sql.SET("go_type = #{record.goType,jdbcType=INTEGER}");
        }
        
        if (record.getGoValue() != null) {
            sql.SET("go_value = #{record.goValue,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Message record) {
        ...
        if (record.getGoType() != null) {
            sql.SET("go_type = #{goType,jdbcType=INTEGER}");
        }
        
        if (record.getGoValue() != null) {
            sql.SET("go_value = #{goValue,jdbcType=VARCHAR}");
        }
